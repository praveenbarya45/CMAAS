...
if(count($_POST)>0) {
 ...
 $result = mysqli_query($con,"SELECT * FROM organisations WHERE org_mobile='" . $_POST["omobile"] . "' and password = '". $pass."'");
$row  = mysqli_fetch_array($result);
if(is_array($row)) {
$_SESSION["id"] = $row['id'];
$_SESSION["name"] = $row['org_mobile'];
} else {
        ...
        <div class="container">
            ...
            <div class="row">
               <div class="col-xl-5 col-lg-5 col-md-5 co-sm-l2">
                    <div class="about_box">
                        <h2>Organisation<br> Sign In<br><strong class="black"></strong></h2>
    ...
    <div class="">
      <div class="">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <input type="tel" name="omobile" placeholder="Mobile Number" required />
          </div>
          <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-key"></i></span>
            <input type="password" name="password" placeholder="Enter Password" required />
          </div>
               
            <input style="background:#052501" type="submit" name="submit" class="btn btn-primary" value="Organisation Sign In">
