            ...
            <div class="col-sm-12">
              <div class="home-tab">
                ...
                <br><br>
                      ...
                      <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-home"></i></span>
                      <label>Organsation Name</label>
            <input type="text" value="<?php echo $name; ?>" />
          </div>
          
           <div class="row clearfix">
           <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-phone"></i></span>
                      <label>&emsp;Organsation Mobile</label>
            <input type="text" value="<?php echo $mob; ?>" />
           </div>
           </div>
           
          <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-address"></i></span>
            <label>Organsation Address</label>
         
            &emsp;<input type="text"  value="<?php echo $add; ?>" />
          </div>
          
         
           <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-map"></i></span>
            <label>Organsation City</label>
         
            &emsp;<input type="text"  value="<?php echo $city; ?>" />
          </div>
