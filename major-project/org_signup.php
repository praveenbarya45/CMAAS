...
$sql="INSERT INTO organisations (org_name,org_mobile,password,org_email,org_image,org_address,org_city,dist_id) VALUES ('".$oname."','".$mobile."','".$pass."','".$email."','".$image."','".$address."','".$city."','".$dist."')";
        ...
        <div class="container">
            ...
            <div class="row">
               <div class="col-xl-5 col-lg-5 col-md-5 co-sm-l2">
                    <div class="about_box">
                        <h2>Organisation Registration<br><strong class="black"></strong></h2>
                        <div class="form_wrapper">
  <div class="form_container">
  
    <div class="">
      <div class="">
        <form method="POST" action="org_signup.php" enctype="multipart/form-data">
...
?>
       ...
       <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-image"></i></span>
            ...
            <input type="submit" name="save" class="btn btn-primary" value="Organisation Sign-Up">
