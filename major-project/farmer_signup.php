...
$sql="INSERT INTO farmers (farmer_name,farmer_lname,farmer_area,farmer_account,farmer_mobile,password,farmer_image,farmer_aadhar,farmer_pancard,farmer_nominee,nominee_relationship,farmer_email,dist_id,farmer_payment_mode,farmer_address,farmer_city) VALUES ('".$fname."','".$lname."','".$area."','".$acc_no."','".$mobile."','".$pass."','".$image."','".$aadhar_card."','".$pan_card."','".$nominee_name."','".$nominee_relation."','".$email."','".$dist."','".$pm."','".$add."','".$city."')";
        ...
        <div class="container">
            ...
            <div class="row">
               <div class="col-xl-5 col-lg-5 col-md-5 co-sm-l2">
                    <div class="about_box">
                        <h2>Farmer Sign Up<br><strong class="black"></strong></h2>
                        <div class="form_wrapper">
  <div class="form_container">
  
    <div class="">
      <div class="">
        <form method="POST" action="farmer_signup.php" enctype="multipart/form-data">
          ...
          <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-id-card"></i></span>
            <input type="tel" name="aadhar_card" placeholder="Aadhar Card Number" required />
          </div>
          <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-id-card"></i></span>
            <input type="tel" name="pan_card" placeholder="Pan Card Number" required />
          </div>
          <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-bank"></i></span>
            <input type="tel" name="acc_no" placeholder="Bank Account Number" required />
          </div>
          
          <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-image"></i></span>
            <input type="file" name="image" placeholder="DOB" required />
          </div>
...
<select style="color: #000000;" name='dist_id' class='form-control'>
           <?php
...
?>
 ...
 <div class="input_field form-group col_half"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-inr"></i> Select Payment Method</span>
     <select style="color: #000000;" name='payment_mode' class='form-control'>
     ...
     <option style='background:#ffffff; color: #000000;' value='Online Banking'>Online Banking</option>
           ...
           <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-map"></i></span>
            <input type="text" name="farmer_address" placeholder="Address" required />
          </div>
           <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-map"></i></span>
            <input type="text" name="farmer_city" placeholder="City" required />
          </div>
          
           <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-area-chart"></i></span>
            <input type="text" name="area" placeholder="Total Farming Area (In Acres)" required />
          </div>
          <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-user"></i></span>
          ...
          <div class="input_field form-group"> <span><i style="color:#163f03" aria-hidden="true" class="fa fa-link"></i></span>
            <input type="text" name="nominee_relation" placeholder="Relationship With Nominee" required />
          </div>
            ...
            <input type="submit" name="save" class="btn btn-primary"  value="Farmer Sign-Up">
