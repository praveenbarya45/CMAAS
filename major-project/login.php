        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-5 col-md-5 co-sm-l2">
                    <div class="about_box">
                        <h2>Sign In<br><strong class="black"></strong></h2>
                        <br>
                        <br>
                       
                        <a  type="submit"  href="farmer_login.php" class="btn btn-primary">Farmer Sign-In</a>
                        <br><br>
                          <a type="submit"  href="org_login.php" class="btn btn-primary">Organisation Sign-In</a>
                
                    </div> <br>
                    <a style="color:#4bc714" href="signup.php">New User ? Sign Up</a>
