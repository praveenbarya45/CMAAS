...
$sql="INSERT INTO orders (name,service,phone,email,description,vehicle) VALUES ('".$name."','".$sid."','".$phone."','".$email."','".$message1."','".$vid."')";
...
"Name :  $name.\n".
     ...
     " Vehicle Name : $vname.\n".
      " Description : $message1.\n".
        "\n----*  Thank You  *---- \n".
$email ='motherlogistics87@gmail.com' ;//<== update the email address
