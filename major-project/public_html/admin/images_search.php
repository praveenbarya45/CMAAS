...
if(isset($_POST["query"]))
{
 ...
 $query = "SELECT * FROM images WHERE images.title LIKE '%".$search."%'  ";
}
else
{
   ...
   <tr class="a3"  style="color:#333">
    <td><p style="color:#666666"><?php echo $cnt;?> </p></td>
     <td><p style="color:#666666"><?php echo $row["title"];?> </p></td>
      ...
      <td  style="width:300px;height:100px;"><img src="img/<?php echo $row["image"];?> " style="width:150px;height:80px;"></td>
	
   <td>  
    <a href="edit_image.php?id=<?php echo $row["id"];?> "  style="height:30px;  font-size:12px" class="btn btn-success btn-sm edit btn-flat"><i class="fa fa-edit"></i> Edit</a>
 
   <a href="delete_image.php?id=<?php echo $row["id"];?> " style="height:30px;  font-size:12px" class="btn btn-danger btn-sm delete btn-flat"><i class="fa fa-trash"></i> Delete</a></td>
