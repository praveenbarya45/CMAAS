                ...
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                        <div class="location_icon_bottum_tt">
                            <ul>
                                 <li><a style="color:#fff" href="login.php" class="btn btn-primary"><i class="fa fa-sign-in" aria-hidden="true"></i>
&nbsp;Login</a></li>
                                 <li><a style="color:#fff"  href="signup.php" class="btn btn-primary"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Sign Up</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-5 col-md-5 co-sm-l2">
                    <div class="about_box">
                        ...
                        <br>
                        <br>
                        <a  type="submit"  href="farmer_signup.php" class="btn btn-primary">Farmer Sign-Up</a>
                        <br><br>
                          <a type="submit"  href="org_signup.php" class="btn btn-primary">Organisation Sign-Up</a>
